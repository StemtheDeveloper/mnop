            ...
            <div className="policy-content">
                ...
                <div className="policy-toc">
                    ...
                    <ol className="toc-list">
                        <li><a onClick={() => scrollToSection('info-collect')} href="#info-collect">Information We Collect</a></li>
                        <li><a onClick={() => scrollToSection('info-use')} href="#info-use">How We Use Your Information</a></li>
                        <li><a onClick={() => scrollToSection('info-sharing')} href="#info-sharing">Information Sharing and Disclosure</a></li>
                        <li><a onClick={() => scrollToSection('data-security')} href="#data-security">Data Security</a></li>
                        <li><a onClick={() => scrollToSection('your-rights')} href="#your-rights">Your Rights and Choices</a></li>
                        <li><a onClick={() => scrollToSection('children')} href="#children">Children's Privacy</a></li>
                        <li><a onClick={() => scrollToSection('changes')} href="#changes">Changes to This Privacy Policy</a></li>
                        <li><a onClick={() => scrollToSection('contact')} href="#contact">Contact Us</a></li>
                    </ol>
                </div>
