                                                        ...
                                                        <tbody>
                                                            {designerSales.map(sale => (
                                                                <tr key={sale.id} className="sales-row">
                                                                    <td className="sales-order-id">{sale.orderNumber}</td>
                                                                    <td className="sales-date">{formatDate(sale.date)}</td>
                                                                    <td className="sales-customer">{sale.customerName}</td>
                                                                    ...
                                                                    <td className="sales-revenue">{formatPrice(sale.revenue)}</td>
